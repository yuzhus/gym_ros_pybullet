...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def __init__(self, check_freq: int, log_dir: str, verbose: int = 1):
        ...
        self.save_path = os.path.join(log_dir, "Best_retrain_damodel_with_demo_v2")
...
if __name__ == '__main__':
  ...
  demo_replay_buffer = load_from_pkl(path=f"{outdir}/Non-optimal_expert_demo_v3")
  ...
  loaded_model = DASACBC.load(f"{outdir}/SAC_v1", demo_replay_buffer, env=env, use_sde=True)
  ...
  loaded_model.learn(retain_timesteps, callback=callback, tb_log_name="dasac_nonoptimal_v17", reset_num_timesteps=False)

  loaded_model.save(f"{outdir}/DASAC_retrained_with_demo")
